...
5. Finally, a nice summary plot of your work using **margins** library:
...
6. Logistics regression coefficients do not offer marginal effects on how much eah variable affects the probability of the '1' outcome. We can get it like this:
...
In this case I need plot per variable:
```{r, eval=TRUE}
